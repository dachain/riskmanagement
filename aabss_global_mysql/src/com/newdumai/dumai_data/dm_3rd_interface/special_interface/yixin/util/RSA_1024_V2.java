package com.newdumai.dumai_data.dm_3rd_interface.special_interface.yixin.util;
...
public class RSA_1024_V2 {
	...
	public static void main(String [] args)
	{
		try
		{
			...
			RSAPublicKey rsaPublicKeyFromCrt = gainRSAPublicKeyFromCrtFile(publicKeyCrtFile);
			...
			RSAPublicKey rsaPublicKeyFromPem = gainRSAPublicKeyFromPemFile(publicKeyPemFile);
