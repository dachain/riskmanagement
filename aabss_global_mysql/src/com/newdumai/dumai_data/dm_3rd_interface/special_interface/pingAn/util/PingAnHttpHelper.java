package com.newdumai.dumai_data.dm_3rd_interface.special_interface.pingAn.util;
...
public class PingAnHttpHelper {
	...
	public Map<String, Object> getBaseParams(Map<String, Object> params)throws NoSuchAlgorithmException {
	...
	public HttpPost postForm(String url, Map<String, Object> params)throws Exception {
